        ...
        <div class="container-fluid">
            <div class="row row-container">
                ...
                <div class="col-9 user-content">
                    ...
                    <form action="alterarDado.php" method="post" class="dados-div">
                        <div class="mb-3 input-div">
                            <?php
                                echo '<input type="email" name="email" class="form-control" placeholder="'.$_COOKIE['user_email'].'" required>';
                            ?>
                        </div>
                        <input type="submit" class="btn btn-outline-secondary btn-alterar" value="Alterar">
                    </form>
                    <form action="alterarDado.php" method="post" class="dados-div">
                        <div class="mb-3 input-div">
                            <?php
                                echo '<input type="password" name="senha" class="form-control" placeholder="'.$_COOKIE['user_senha'].'" required>';
                            ?>
                        </div>
                        <input type="submit" class="btn btn-outline-secondary btn-alterar" value="Alterar">
                    </form>
